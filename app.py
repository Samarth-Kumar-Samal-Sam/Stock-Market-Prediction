...
try:
    # Keep your original path. If your folder is "Assets", change to "Assets/SAM.jpg"
    profile_img = Image.open("assets/SAM.jpg")
    buf = io.BytesIO()
    profile_img.save(buf, format="PNG")
    ...
    <div class="footer">
        <div class="footer-content">
            <img src="data:image/png;base64,{img_str}" class="footer-avatar" alt="Profile">
            <div class="footer-text">
                <div class="footer-name">Samarth Kumar Samal</div>
                <div class="footer-tagline">Data Science Student | University of Minnesota Twin Cities</div>
            </div>
        </div>
    </div>
    """,
